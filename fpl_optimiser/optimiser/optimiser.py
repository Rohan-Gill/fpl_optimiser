...
class MILPOptimiser:
    ...
    def calulate_optimal_team(self) -> None:
        ...
        for constraint in constraints:
            if constraint.find("ProbabilityOfStartingConstraint_GW") != -1:
                value = constraints.get(constraint).value()
                slack = constraints.get(constraint).slack
                print(constraint, value, slack)
        """
